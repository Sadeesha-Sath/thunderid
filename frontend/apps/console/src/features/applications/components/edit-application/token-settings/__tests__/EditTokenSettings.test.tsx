...
//
// The mock also carries its own local "which sub-tab is selected" state (mirroring the real
// component's independent activeValidationTab) plus a real react-hook-form Controller bound to
// the refreshTokenValidity/validityPeriod field it's given — this lets reset-behavior tests prove
// both halves of the bug fix: the field value reverts on a sectionResetKey bump, AND this local
// tab selection is untouched (since EditTokenSettings no longer remounts to achieve the former).
